...
namespace NeuralNetworkTSU
{
    ...
    public static class HandwrittenDigits
    {
        ...
        public static void Run()
        {
            ...
            var network = new NeuralNetwork(inputLength, 100, 10, 0.3);

            var dataset = File.ReadAllLines(@"D:/Aleks/train.csv");

            var allInputs = dataset
                .Select(x => x.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries))
                .Skip(inputLength).ToArray();
            ...
            var queryDataset = File.ReadAllLines(@"D:/Aleks/test.csv"); ;
